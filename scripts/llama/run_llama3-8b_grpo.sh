...
experiment_name="llama3.1-8b-ft-dr.grpo-n8-alltasks"
...
model_path=".../checkpoints_sft/multiturn-sft/llama3.1-8b-androidlab-ft-ours/global_step_780_hf"

train_files="data_train_llama3.1_inst/all_apps_combined.parquet"
test_files="data_test_llama3.1_inst/all_apps_combined.parquet"
