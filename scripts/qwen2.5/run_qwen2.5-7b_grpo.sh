...
experiment_name=qwen2.5-7b-ft-dr.grpo-n8-alltasks
...
model_path=...checkpoints_sft/multiturn-sft/qwen-2.5-7b-androidlab-ft-ours/global_step_781_hf

train_files="data_train_qwen_inst/all_apps_combined.parquet"
test_files="data_test_qwen_inst/all_apps_combined.parquet"
