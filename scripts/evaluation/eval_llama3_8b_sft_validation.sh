...
TRAIN_FILE_PATH="data_train_llama3.1_inst/all_apps_combined.parquet"
TEST_FILE_PATH="data_test_llama3.1_inst/all_apps_combined.parquet"

PROJECT_NAME='svagent'
EXPERIMENT_NAME="llama3.1-8b_ft-ours"
