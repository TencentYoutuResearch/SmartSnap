...
echo "date=${date}"
### 使用非思考模式
MODEL_PATH="...checkpoints_sft/multiturn-sft/qwen-3-32b-androidlab-ft-ours/latest_global_step_781_hf" 

TRAIN_FILE_PATH="data_train/all_apps_combined.parquet"
TEST_FILE_PATH="data/all_apps_combined.parquet"

PROJECT_NAME='svagent'
EXPERIMENT_NAME="qwen3-32b_ft-ours"
